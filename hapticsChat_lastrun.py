...
text = visual.TextStim(win=win, name='text',
    ...
    depth=0.0);
sound_1 = sound.Sound(u'250', secs=-1)
sound_1.setVolume(1)

# Initialize components for Routine "survey"
surveyClock = core.Clock()
rating = visual.RatingScale(win=win, name='rating', marker=u'triangle', size=1.0, pos=[0.0, -0.4], low=1, high=7, labels=[u'Positive', u' Negative'], scale=u'')
...
text_2 = visual.TextStim(win=win, name='text_2',
    ...
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
sound_2 = sound.Sound(u'120', secs=-1)
sound_2.setVolume(1)
...
text_3 = visual.TextStim(win=win, name='text_3',
    ...
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
sound_3 = sound.Sound(u'120', secs=-1)
sound_3.setVolume(1)
...
text_4 = visual.TextStim(win=win, name='text_4',
    ...
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
sound_4 = sound.Sound(u'250', secs=-1)
sound_4.setVolume(1)
...
# keep track of which components have finished
secondComponents = [text_2, sound_2, key_resp_3]
...
# keep track of which components have finished
thirdComponents = [text_3, sound_3, key_resp_4]
...
# keep track of which components have finished
fourthComponents = [text_4, sound_4, key_resp_5]
